...
const AddHabit = (props) => {
    ...
    return (
        <div className="add__habit-modal" style={props.showModal ? { "display": 'block' } : { "display": 'none' }}>
                    ...
                    {({ errors, touched }) => (
                        <Form className="add__habit">
                            ...
                            <div className="form-submit">
                                ...
                                >{props.nameSubmit}</button>
                                <button className='my-btn' onClick={() => props.onClose(false)}>Закрыть</button>
                            </div>
                        </Form>
                    )}
